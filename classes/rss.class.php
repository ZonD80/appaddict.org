	...
	**/
	public function get($items) {
		...
		foreach($items as $item) {
		        ...
		        $res.="\t\t\t<description><![CDATA[<img align=\"right\" hspace=\"5\" src=\"".stripslashes($item["image"])."\"/><br/>".stripslashes(nl2br($item["description"]))."<br/><br/><a href=\"".stripslashes($item["link"])."\">View on AppAddict</a> | <a href=\"appaddict://trackid=".stripslashes($item["trackid"])."\">View in iOS App</a>]]></description>\n";
