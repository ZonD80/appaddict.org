<?php
if (!defined("INIT")) die('Direct access to this file not allowed');
...
class FileCacheDriver implements CacheDriver
{
	...
	public function __construct($dir=NULL)
	{
		...
		else if(!$this->checkDirectory($this->dir)) throw new CacheException('Unable to use given directory ('.$this->dir.'). Check file permissions.');
	}
